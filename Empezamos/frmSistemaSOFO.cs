...
namespace Empezamos
{
    public partial class SistemaSOFO : Form
    {
        ...
        private void PermisosUsuarios()
        {
            ...
            if (EUserLoginCache.cCargo == ECargos.Cajero)
            {
                btnMantenimiento.Enabled = false;
                //btnEstadisticas.Enabled = false;

            }
            if (EUserLoginCache.cCargo == ECargos.Gerente)
            {
                btnMantenimiento.Enabled = false;
            }
        ...
        {
            frmProducto fm = new frmProducto();
        ...
        {
            frmRegistroEntrada fm = new frmRegistroEntrada();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
            //---invocamos el metodo ocultar
            hideSubMenu();
        ...
        {
            frmInformeVentas fm = new frmInformeVentas();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
            //showSubMenu(panelSubMenuReportes);
            //---invocamos el metodo ocultar
        ...
        {
            frmInformeAlmacen fm = new frmInformeAlmacen();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
            //showSubMenu(panelSubMenuReportes);
            //---invocamos el metodo ocultar
        ...
        {
            frmBuscProducto fm = new frmBuscProducto();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
            //showSubMenu(panelSubMenuReportes);
            //---invocamos el metodo ocultar
